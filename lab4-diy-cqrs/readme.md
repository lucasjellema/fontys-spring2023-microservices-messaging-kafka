# Lab 4 - DIY CQRS using Apache Kafka
...
## CRM Microservice 
Focus on the directory *CRM* in the lab4 folder. Here is where the CRM Service sources are.
...
Install the dependencies for the CRM service and run the service from the command line in the *lab4-diy-cqrs\CRM* directory:
```
npm install
npm start
```
